                ...
                for elem in jsonData["assets"]:
                    ...
                    if elem["macaddress"][0:11] == "5a-c2-15-01":
                        ...
                        if employee:
                            ...
                            if elem["alert"] > 0 and elem['alert'] != 2:
                                ...
                                alertInsert.append(Alert(id=Alert.id, value=elem["alert"], timestamp=timeStamp,
                                                       floor_id=floor_id,
                            ...
                            if zone:
                                ...
                                zonesInsert.append(ZoneTracking(
                    ...
                    # # print("success", elem["macaddress"][0:11])
                        ...
                        if temp:
                            ...
                            tempInsert.append(DailyTemperature(
                    ...
                    #     pass
                        ...
                        pass
                session.bulk_save_objects(alertInsert)
                session.commit()
                session.bulk_save_objects(zonesInsert)
                session.commit()
                session.bulk_save_objects(tempInsert)
                session.commit()
